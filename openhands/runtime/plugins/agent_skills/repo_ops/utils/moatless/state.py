...
from openhands.runtime.plugins.agent_skills.repo_ops.utils.moatless.workspace import Workspace
from openhands.runtime.plugins.agent_skills.repo_ops.utils.moatless.file_context import FileContext
# from openhands.runtime.plugins.agent_skills.repo_ops.utils.moatless.loop import AgenticLoop
...
class AgenticState(ABC, BaseModel):
    ...
    def create_file_context(
        self, files: Optional[List[FileWithSpans]] = None, **kwargs
    ) -> FileContext:
        if files is None:
            files = []
